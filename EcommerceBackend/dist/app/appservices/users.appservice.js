...
const usersDto_1 = require("../../submodules/Portfolio-Platform-Dtos/usersDto");
...
let UsersAppService = class UsersAppService extends AppServiceBase_1.default {
    constructor(usersRepository, http) {
        super(http, usersRepository, usersEntity_1.UsersEntity, usersEntity_1.UsersEntity, usersDto_1.UsersDto, dto.usersentityJson, dto.usersdtoJson, dto.usersentityToDtoJson, dto.usersdtoToEntityJson);
...
UsersAppService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(usersEntity_1.UsersEntity)),
