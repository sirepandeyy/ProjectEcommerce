...
let UsersService = class UsersService extends AppServiceBase_1.default {
    constructor(usersRepository, http) {
        super(http, usersRepository, users_1.User, users_1.User, usersDto_1.UserDto, dto.usersentityJson, dto.usersdtoJson, dto.usersentityToDtoJson, dto.usersdtoToEntityJson);
